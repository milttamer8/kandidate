    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-10">
                                <textarea class="form-control m-input" id="general_notes" name="general_notes"
                                          rows="6">{{$candidate->general_notes}}</textarea>
        </div>
    </div>
    <div class="form-group m-form__group row">
        <div class="col-lg-12">
    ...
    <div class="content_experience">
        @foreach($candidate_experience as $row)
            ...
            <div class="form-experience box-container" id="modal_id_{{$row->id}}">
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left"><font>Industry and sectors</font></label>
                    <div class="col-lg-6">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left">Start Date</label>
                    <div class="col-lg-2">
                        <div class="m-radio-inline col-lg-12">
                            <input type="text" name="work_start_{{$row->id}}" class="form-control form-control-1 input-sm from" placeholder="Date" value="{{$row->experience_start}}">
                        </div>
                    </div>
                    <label class="col-lg-2 col-form-label text-center">End Date</label>
                    <div class="col-lg-2">
                        <div class="m-radio-inline col-lg-12">
                            <input type="text" name="work_end_{{$row->id}}" class="form-control form-control-1 input-sm from" placeholder="Date" value="{{$row->experience_end}}">
                        </div>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left">Company</label>
                    <div class="col-lg-6">
                        <div class="m-radio-inline col-lg-6">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left">Title and Role</label>
                    <div class="col-lg-6">
                        <div class="m-radio-inline col-lg-6">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left"><font>Technologies used at this company</font></label>
                    ...
                    <div class="col-lg-6">
                        <div class="m-radio-inline">
                            <textarea class="form-control m-input" name="work_experience_position_description_{{$row->id}}"
                                      rows="6">{{$row->experience_description}}</textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class='add-form-container box-container d-none'>
            <form class="add-form-work" method="post" action="/admin/add_experience/{{$candidate->id}}">
                ...
                <div class='form-group m-form__group row'>
                    ...
                    <div class='col-lg-2'>
                        <div class='m-radio-inline col-lg-12'>
                            <input type="text" name="work_start" class="form-control form-control-1 input-sm from" placeholder="Date" value="">
                        </div>
                    </div>
                    <label class='col-lg-2 col-form-label text-center'>End Date</label>
                    <div class='col-lg-2'>
                        <div class='m-radio-inline col-lg-12'>
                            <input type="text" name="work_end" class="form-control form-control-1 input-sm from" placeholder="Date" value="">
                        </div>
                    </div>
                </div>
                <div class='form-group m-form__group row'>
                ...
                <div class='form-group m-form__group row'>
                    ...
                    <div class='col-lg-6'>
                        <div class='m-radio-inline'>
                            <textarea class='form-control m-input' name='work_exp_pos_description' rows='6'></textarea>
                        </div>
                    </div>
                </div>
                <div class='text-right'>
...
<!--education begin-->
    <div class="form-group m-form__group row">
        <div class="col-lg-12 box-container-title"><h2>Education, University and Degrees</h2></div>
    </div>
    ...
    <div class="education_experience">
        ...
        <div class="form-experience box-container" id="modal_id_edu_{{$row->id}}">
            <div class="form-group m-form__group row">
                <label class="col-lg-4 col-form-label text-left">Name of University</label>
                <div class="col-lg-6">
                    <div class="m-radio-inline">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-2">
                    <div class="m-radio-inline col-lg-12">
                        <input type="text" name="edu_start_{{$row->id}}" class="form-control form-control-1 input-sm from" placeholder="Date" value="{{$row->education_start}}">
                    </div>
                </div>
                <label class="col-lg-2 col-form-label text-center">End Date</label>
                <div class="col-lg-2">
                    <div class="m-radio-inline col-lg-12">
                        <input type="text" name="edu_end_{{$row->id}}" class="form-control form-control-1 input-sm from" placeholder="Date" value="{{$row->education_end}}">
                    </div>
                </div>                
            </div>

            <div class="form-group m-form__group row">
                <label class="col-lg-4 col-form-label text-left"><font>Academic Degree</font></label>
                <div class="col-lg-6">
            ...
            <div class="form-group m-form__group row">
                <label class="col-lg-4 col-form-label text-left">Field of study and further information</label>
                <div class="col-lg-6">
                    <div class="m-radio-inline">
        ...
        <div class="add-form-education box-container d-none">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-2">
                        <div class="m-radio-inline col-lg-12">
                            <input type="text" name="edu_start" class="form-control form-control-1 input-sm from" placeholder="Date" value="">
                        </div>
                    </div>
                    <label class="col-lg-2 col-form-label text-center">End Date</label>
                    <div class="col-lg-2">
                        <div class="m-radio-inline col-lg-12">
                            <input type="text" name="edu_end" class="form-control form-control-1 input-sm from" placeholder="Date" value="">
                        </div>
                    </div>                    
                </div>
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-4 col-form-label text-left"><font>Academic Degree</font></label>
                    <div class="col-lg-6">
                        <select class='form-control' name='edu_traning'>
                            @foreach(\App\Kandidate::EDUCATION_ITEMS as $id => $sector)
                                <option value='{{$id}}'>{{$sector}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <div class="m-radio-inline">
                            <textarea class="form-control m-input" name="edu_description" rows="6"></textarea>
                        </div>
                    </div>
                </div>
                <div class="text-right">
