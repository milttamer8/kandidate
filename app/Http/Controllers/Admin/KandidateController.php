...
class KandidateController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $candidate_experience = \App\WorkExperience::where('kandidate_id', $id)->get();
        $candidate_education = \App\Education::where('kandidate_id', $id)->get();
    ...
    public function update_experience($id, Request $request){
        ...
        \App\WorkExperience::where('id', $request->currentIndex)
    ...
    public function update_education($id, Request $request){
        \App\Education::where('id', $request->currentIndex)
                          ->where('kandidate_id', $id)
    ...
    public function delete_experience($id, Request $request){
        \App\WorkExperience::where('id', $request->currentIndex)->delete();
        echo "";
    }

    public function delete_education($id, Request $request){
        \App\Education::where('id', $request->currentIndex)->delete();
        echo "";
    }
    public function add_experience($id, Request $request){
        ...
        $NewExperience->kandidate_id = $id;
        $NewExperience->experience_sector = $request->get('work_exp_sector');
        $NewExperience->experience_start = $request->get('work_start');
        $NewExperience->experience_end = $request->get('work_end');
        $NewExperience->experience_company = $request->get('work_exp_company_name');
        $NewExperience->experience_postion = $request->get('work_exp_position');
        $NewExperience->skills_with_work = $skills_with_work;
        $NewExperience->experience_description = $request->get('work_exp_pos_description');
        $NewExperience->save();
    ...
    public function add_education($id, Request $request){
        ...
        $NewEducation->kandidate_id = $id;
        $NewEducation->graduation = $request->get('education_graduation');
        $NewEducation->training_facility = $request->get('edu_traning');
        $NewEducation->education_start = $request->get('edu_start');
        $NewEducation->education_end = $request->get('edu_end');
        $NewEducation->description = $request->get('edu_description');
        $NewEducation->save();
